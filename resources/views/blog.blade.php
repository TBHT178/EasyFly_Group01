                                ...
                                <div class="navbar-wrap main-menu d-none d-lg-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="active menu-item-has-children"><a href="#">Blog</a>
                                            <ul class="submenu">
                                                <li class="{{ Route::currentRouteNamed('blog') ? 'active' : ' ' }}"> <a href="{{ Route::currentRouteNamed('blog') ? 'active' : ' ' }}">Our Blog</a></li>
                    ...
                    <div class="col-lg-8">
                        <div class="inner-blog-item">
                            <div class="inner-blog-thumb">
                                <a href="{{route('blog-details')}}"><img src="assets/img/blog/inner_blog_img01.jpg" alt="img"></a>
                            </div>
                            <div class="inner-blog-content">
                                <div class="blog-meta">
                                    <ul>
                                        ...
                                        <li><i class="fa-regular fa-user"></i> <a href="#">Tram</a></li>
                                        <li><i class="fa-regular fa-bell"></i>Aug 17, 2023</li>
                                    </ul>
                                </div>
                                <h2 class="title"><a href="{{route('blog-details')}}">Purchase flight ticket easily & securely</a></h2>
                                ...
                                <a href="{{route('blog-details')}}" class="read-more">Read More <i class="fa-solid fa-angle-right"></i></a>
                            </div>
                        </div>
                        <div class="inner-blog-item">
                            <div class="inner-blog-thumb">
                                <a href="{{route('blog-details')}}"><img src="assets/img/blog/inner_blog_img02.jpg" alt="img"></a>
                            </div>
                            <div class="inner-blog-content">
                                <div class="blog-meta">
                                    <ul>
                                        ...
                                        <li><i class="fa-regular fa-user"></i> <a href="#">Phat</a></li>
                                        <li><i class="fa-regular fa-bell"></i>Aug 17, 2023</li>
                                    </ul>
                                </div>
                                <h2 class="title"><a href="{{route('blog-details')}}">Car Rental Provider easily & securely</a></h2>
                        ...
                        <div class="inner-blog-item">
                            <div class="inner-blog-thumb">
                                <a href="{{route('blog-details')}}"><img src="assets/img/blog/inner_blog_img03.jpg" alt="img"></a>
                            </div>
                            <div class="inner-blog-content">
                                <div class="blog-meta">
                                    <ul>
                                        ...
                                        <li><i class="fa-regular fa-user"></i> <a href="#">Khai</a></li>
                                        <li><i class="fa-regular fa-bell"></i>Aug 17, 2023</li>
                                    </ul>
                                </div>
                                <h2 class="title"><a href="{{route('blog-details')}}">Services in 7 different languages</a></h2>
                                <p>Enjoy an even safer and more comfortale travel experience with the Top class Airlines mobile apps You can
                                    complete all travel processes such as purchasing a ticket the creating a mobile boarding pass, or checking
                                    in via a single channel.</p>
                                <a href="{{route('blog-details')}}" class="read-more">Read More <i class="fa-solid fa-angle-right"></i></a>
                                ...
                                <div class="rc-post-list">
                                    <div class="rc-post-item">
                                        <div class="rc-post-thumb">
                                            <a href="{{route('blog-details')}}"><img src="assets/img/blog/rc_post_img01.jpg" alt=""></a>
                                        </div>
                                        <div class="rc-post-content">
                                            <span class="date"><i class="fa-regular fa-bell"></i>Aug 17, 2023</span>
                                            <h4 class="title"><a href="{{route('blog-details')}}">Car Rental Provider</a></h4>
                                            <a href="#" class="author">Alex Jonson</a>
                                        </div>
                                    </div>
                                    <div class="rc-post-item">
                                        <div class="rc-post-thumb">
                                            <a href="{{route('blog-details')}}"><img src="assets/img/blog/rc_post_img02.jpg" alt=""></a>
                                        </div>
                                        <div class="rc-post-content">
                                            <span class="date"><i class="fa-regular fa-bell"></i>Aug 17, 2023</span>
                                            <h4 class="title"><a href="{{route('blog-details')}}">Purchase flight ticket</a></h4>
                                            <a href="#" class="author">Alex Jonson</a>
                                        </div>
                                    </div>
                                    <div class="rc-post-item">
                                        <div class="rc-post-thumb">
                                            <a href="{{route('blog-details')}}"><img src="assets/img/blog/rc_post_img03.jpg" alt=""></a>
                                        </div>
                                        <div class="rc-post-content">
                                            <span class="date"><i class="fa-regular fa-bell"></i>Aug 17, 2023</span>
                                            <h4 class="title"><a href="{{route('blog-details')}}">Services in 7 different</a></h4>
                                            <a href="#" class="author">Alex Jonson</a>
                                        </div>
                                    </div>
                                </div>
