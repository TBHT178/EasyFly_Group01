                    ...
                    <div class="booking-wrap">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="bOOKing-tab" data-bs-toggle="tab" data-bs-target="#bOOKing-tab-pane" type="button" role="tab" aria-controls="bOOKing-tab-pane" aria-selected="true"><i class="flaticon-flight"></i>air
                                    BOOKing</button>
                            </li>
                        </ul>
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="form-grp select">
                                                            ...
                                                            <select id="from" name="from" class="form-select abc" aria-label="Default select example">
                                                    ...
                                                    <li>
                                                        <div class="form-grp select">
                                                            ...
                                                            <select id="to" name="to" class="form-select abc" aria-label="Default select example">
                                                                @foreach ($airports as $airport)
                                                                <option value="{{ $airport->airport_code }}">
                                                                    {{ $airport->airport_name }}
                                                                </option>
                                                        ...
                                                        <div class="form-grp date">
                                                            <ul>
                                                                <li>
                                                                    ...
                                                                    <input type="date" name="depart" style="width: 97.1px" value="<?php echo date('Y-m-d'); ?>" />

                                                                </li>
                                                                <li>
                                                                    <label for="shortBy">Return</label>
                                                                    <input type="date" style="width: 97.1px" name="return" value="<?php echo date('Y-m-d'); ?>" />
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="form-grp economy">
                                                            ...
                                                            <input type="number" id="text" value="1" name="passenger">
                                                        </div>
                                                    </li>
                                                </ul>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="destination-content">
                        <p>Get rewarded for your travels – unlock instant savings of 10% or more with a free
                            <span>EasyFlyinfo.com</span> account
                        </p>
                        <ul>
                            <li>
