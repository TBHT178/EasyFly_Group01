    ...
    <table class="table .table-responsive" style="padding-bottom: 50px">
        ...
        <tbody id="flight-row">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('flight_update', ['code' => $flight->flight_id]) }}"><button class="btn btn-primary">Update</button></a> | <a onclick="confirmation(event)" href="{{ route('flight_delete', ['code' => $flight->flight_id]) }}"><button class="btn btn-danger">Delete</button></a>
                </td>
            </tr>
            @empty
...
tableRow = '<tr>
    ...
    <td>' +
        value.country +
        '</td>
    <td><a href="{{ route('sb_update', ['code' => $flight->flight_id]) }}"><button class="btn btn-primary">Update</button></a>| <a onclick="confirmation(event)" href="{{ route('sb_delete', ['code' => $flight->flight_id]) }}"><button class="btn btn-danger">Delete</button></a></td>
</tr>'
